...
#torch.save(siamese_model.state_dict(), './siamese_network_pointnet2/siamese_pointnet2_regression_msg_20_epochs_data_augmentation.pth')
#state_dict = torch.load('./siamese_network_pointnet2/siamese_pointnet2_regression_msg_15 epochs.pth', map_location=device)
...
save_path = "./siamese_network_pointnet2/rand_rotations/siamese_network_pointnet2_cls_msg.csv"
